...
class Channel(Gtk.VBox):
    def __init__(self):
        ...
        message_list.add_message('simtr', 'My internet is down, and the only think I can connect to is libera for some reason.')
        message_list.add_message('savask', 'No idea')
        message_list.add_message('Ristovski', 'savask: rofl')

        
        text_entry = Gtk.Entry()
        text_entry.set_icon_from_icon_name(Gtk.EntryIconPosition.SECONDARY, 'go-next-symbolic')
